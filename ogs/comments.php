<?php
	...
	{     
		...
		echo '<td style="padding:5px"><form style="margin:0;" name="like" action="" method="post"><textarea name="reply" placeholder="Reply..." style="width:90%;resize:none;border:none;background:transparent;font-size:12px" rows="1" wrap="physical"></textarea><<input style="vertical-align:top;padding-left:50%" type="submit" value="Post"></form></td>';
		echo '</tr>';
		echo '</table>';
		echo '<br><br>';
	}//end while 
