<?php
	...
	{     
		...
		echo '<td colspan="3" style="padding:5px"><textarea name="reply" placeholder="Reply..." style="width:100%;resize:none;border:none;background:transparent;font-size:12px" rows="1" wrap="physical"></textarea></textarea><br><form name="like" action="" method="post"><p style="text-align:right"><input type="submit" value="Post"></p></form></td>';
		echo '</tr>';
		echo '</table>';
		echo '<br><br>';
	}//end while 
