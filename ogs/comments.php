<?php
	...
	{     
		...
		echo '<td colspan="3" style="padding:5px"><textarea name="reply" placeholder="Reply..." style="width:100%;resize:none;border:none;background:transparent;font-size:12px" rows="1" wrap="physical"></textarea></textarea><form name="like" action="" method="post"><input type="submit" value="Post"></form></td>';
		echo '</tr>';
		echo '</table>';
		echo '<br><br>';
	}//end while 
