			...
			<form name="comments" action="" method="post"> 
				<table width="500px" border="0" cellspacing="0" cellpadding="0"> 
					<tr style="background-color: #f6f6f6"> 
						<td>
							<textarea class='autoExpand' data-min-rows='3' name="comment" placeholder="Submit a post..." style="width:500px;resize:none;border:none;padding:10px;background:transparent;font-size:18px" rows="3" wrap="VIRTUAL"></textarea></textarea>
						</td> 
					</tr> 
	...
	{     
		...
		echo '<td colspan="3" style="padding:5px">
				<form style="margin:0;" name="like" action="" method="post">
					<textarea name="reply" class=\'autoExpand\' placeholder="Reply..." style="width:85%;resize:none;border:none;background:transparent;font-size:12px" rows="1" wrap="physical"></textarea>
