...
class PicksController extends Controller
{
    public function indexAction()
    {
        ...
        if(!self::confirm($session))
            return $this->redirect($this->generateUrl('picks_login'));
        
        $name = $session->get("name", "User");
        $picked = self::picked($name);
        
        return $this->render('PersonalBundle:Picks:index.html.twig', array("name" => $name, "picked" => $picked));
    }
    ...
    public function loginAction()
    {
        ...
        if(isset($response) && $response)
            return $this->redirect($this->generateUrl('picks'));
        else if(isset($response))
            return $this->render('PersonalBundle:Picks:login.html.twig', array('error' => $response));
        else
            return $this->render('PersonalBundle:Picks:login.html.twig');
    }
